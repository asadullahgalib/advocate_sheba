        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 text-center">
                    <a target="_blank" href="{{route('frontend.booking.download')}}" style="background-color: #ED9324;padding: 10px;border-radius: 5px;color: #fff;font-size: 18px;font-weight: bold;"><i class="fa fa-download"></i> Download</a>
                </div>
            </div>
        </div>
    </div>
