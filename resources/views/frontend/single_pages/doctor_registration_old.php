                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-group col-md-6">
                                          <div class="input-group mb-3">
                                             ...
                                             <input type="text" class="form-control" name="experience" value="{{old('experience')}}" placeholder="Experience *">
                                          </div>
                                          <font style="color:red">{{($errors->has('experience'))?($errors->first('experience')):''}}</font>
                                       </div>
                                       <div class="form-group col-md-6">
                                          <div class="input-group mb-3">
                                             <div class="input-group-append">
                                       ...
                                       <div class="form-group col-md-6">
                                          <div class="input-group mb-3">
                                             <div class="input-group-append">
                                                 <span class="input-group-text" style="padding: 7px 12px;"><i class="fa fa-key"></i></span>
                                             </div>
