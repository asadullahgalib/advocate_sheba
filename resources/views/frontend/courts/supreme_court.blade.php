...
<div class="doctors-blog-page">
    ...
    <div class="blog-container">
        ...
        <div class="blog-header"
            ...
            <h1 class="blog-title">
                <i class="fa fa-bank"></i> Supreme Court
            </h1>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="blog-article-content">
                    ...
                    <p>
                        Supreme Court are an important part of the judicial system
                    ...
                    <div class="tab-content district-tab-content"
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <p>
                                ...
                                আইন অনুযায়ী নিষ্পত্তি করা হয়। Supreme Court-এর অধীনে বিভিন্ন ধরনের
