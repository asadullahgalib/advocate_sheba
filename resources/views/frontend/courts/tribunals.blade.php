...
<div class="doctors-blog-page">
    ...
    <div class="blog-container">
        ...
        <div class="blog-header"
            ...
            <h1 class="blog-title">
                <i class="fa fa-bank"></i> Tribunals
            </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="blog-article-content">
                    ...
                    <p>
                        ...
                        fall within the jurisdiction of নারী ও শিশু নির্যাতন দমন or Criminal
            ...
            <div class="col-md-12">
                ...
                <div class="district-court-tabs">
                    ...
                    <ul class="nav district-tab-buttons"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link"
                                    id="labour-tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#labour-courts-content"
                                    type="button"
                                    role="tab"
                                    aria-controls="labour-courts-content"
                                    aria-selected="true">
                                Labour Courts
                            </button>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link"
                                    id="family-tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#family-courts-content"
                                    type="button"
                                    role="tab"
                                    aria-controls="family-courts-content"
                                    aria-selected="true">
                                Family Courts
                            </button>
                        </li>
                    ...
                    <div class="tab-content district-tab-content"
                        ...
                        <!-- =================================================
                             নারী ও শিশু নির্যাতন দমন CONTENT
                        ================================================== -->
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <h4>
                                নারী ও শিশু নির্যাতন দমন — Overview
                            </h4>

                            <p>
                                নারী ও শিশু নির্যাতন দমন হলো এমন আদালত যেখানে ব্যক্তি, প্রতিষ্ঠান বা সংস্থার মধ্যে
                                <strong style="font-weight: bold;">
                                    সম্পত্তি, অর্থ, চুক্তি, অধিকার, পারিবারিক ও অন্যান্য দেওয়ানি বিষয়ক বিরোধ
                                </strong>
                                আইন অনুযায়ী নিষ্পত্তি করা হয়। Tribunals-এর অধীনে বিভিন্ন ধরনের
                            ...
                            <h5>
                                নারী ও শিশু নির্যাতন দমন-এ কী ধরনের মামলা হতে পারে?
                            </h5>
                                ...
                                <div class="faq-accordion"
                                    ...
                                    <div class="faq-item active">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                নারী ও শিশু নির্যাতন দমন-এর jurisdiction বা এখতিয়ার নির্ধারণের ক্ষেত্রে
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                নারী ও শিশু নির্যাতন দমন-এ সম্পত্তি, টাকা-পয়সা, চুক্তি, মালিকানা,
                        ...
                        <div class="tab-pane fade"
                            ...
                            <h4>
                                Cyber Tribunal — Overview
                            </h4>


                            <p>
                                Cyber Tribunal হলো এমন আদালত যেখানে
                                <strong style="font-weight: bold;">
                            ...
                            <p>
                                ...
                                মামলাটি Cyber Tribunal-এর মাধ্যমে পরিচালিত হতে পারে।
                            ...
                            <h5>
                                Cyber Tribunal-এ কী ধরনের মামলা হতে পারে?
                            </h5>
                                ...
                                <div class="faq-accordion"
                                    ...
                                    <div class="faq-item active">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                Cyber Tribunal-এর jurisdiction নির্ভর করে অপরাধের
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                Labour Court-এ ব্যক্তি বা প্রতিষ্ঠানের বিরুদ্ধে
                        ...
                        <div class="tab-pane fade"
                             id="labour-courts-content"
                             role="tabpanel"
                             aria-labelledby="labour-tab"
                             tabindex="0">
                            <h4>
                                Labour Courts — Overview
                            </h4>


                            <p>
                                Labour Courts হলো এমন আদালত যেখানে
                                <strong style="font-weight: bold;">
                                    অপরাধ সংঘটনের অভিযোগ, ফৌজদারি মামলা, অভিযুক্ত ব্যক্তির
                                    বিচার এবং আইন অনুযায়ী শাস্তি বা অন্যান্য আইনগত প্রতিকার
                                </strong>
                            ...
                            <p>
                                কোনো ব্যক্তি বা প্রতিষ্ঠানের বিরুদ্ধে অপরাধ সংঘটনের অভিযোগ
                                উঠলে প্রযোজ্য আইন ও নির্ধারিত বিচারিক প্রক্রিয়া অনুসরণ করে
                                মামলাটি Labour Court-এর মাধ্যমে পরিচালিত হতে পারে।
                                আদালত মামলার নথি, সাক্ষ্য-প্রমাণ, সাক্ষীদের বক্তব্য এবং
                                উভয় পক্ষের আইনগত উপস্থাপনা বিবেচনা করে সিদ্ধান্ত প্রদান করে।
                            </p>
                            ...
                            <h5>
                                Labour Court-এ কী ধরনের মামলা হতে পারে?
                            </h5>
                                ...
                                <div class="faq-accordion"
                                    ...
                                    <div class="faq-item active">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                Labour Court-এর jurisdiction নির্ভর করে অপরাধের
                                                ধরন, প্রযোজ্য আইন এবং সংশ্লিষ্ট আদালতের নির্ধারিত
                                                এখতিয়ারের ওপর। মামলার প্রকৃতি অনুযায়ী কোন আদালতে
                                                বিচার হবে তা আইন দ্বারা নির্ধারিত হতে পারে।
                                            </p>
                        ...
                        <div class="tab-pane fade"
                             id="family-courts-content"
                             role="tabpanel"
                             aria-labelledby="family-tab"
                             tabindex="0">
                            <h4>
                                Family Courts — Overview
                            </h4>


                            <p>
                                Family Courts হলো এমন আদালত যেখানে
                                <strong style="font-weight: bold;">
                                    অপরাধ সংঘটনের অভিযোগ, ফৌজদারি মামলা, অভিযুক্ত ব্যক্তির
                                    বিচার এবং আইন অনুযায়ী শাস্তি বা অন্যান্য আইনগত প্রতিকার
                                </strong>
                            ...
                            <p>
                                Family Court proceedings-এর ক্ষেত্রে অভিযোগের প্রকৃতি, অপরাধের
                                ধরন এবং প্রযোজ্য আইনের ওপর ভিত্তি করে সংশ্লিষ্ট আদালতের
                                jurisdiction নির্ধারিত হয়। মামলার প্রতিটি ধাপে আইনগত
                                প্রক্রিয়া ও আদালতের নির্দেশনা অনুসরণ করা গুরুত্বপূর্ণ।
                            </p>
                            ...
                            <h5>
                                Family Court-এ কী ধরনের মামলা হতে পারে?
                            </h5>
                                ...
                                <div class="faq-accordion"
                                    ...
                                    <div class="faq-item active">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                Family Court-এর jurisdiction নির্ভর করে অপরাধের
                                                ধরন, প্রযোজ্য আইন এবং সংশ্লিষ্ট আদালতের নির্ধারিত
                                                এখতিয়ারের ওপর। মামলার প্রকৃতি অনুযায়ী কোন আদালতে
                                                বিচার হবে তা আইন দ্বারা নির্ধারিত হতে পারে।
                                            </p>
                                    ...
                                    <div class="faq-item">
                                        ...
                                        <div class="faq-answer">
                                            ...
                                            <p>
                                                Family Court-এ ব্যক্তি বা প্রতিষ্ঠানের বিরুদ্ধে
                                                সংঘটিত বিভিন্ন অপরাধের অভিযোগে মামলা হতে পারে।
                                                অপরাধের প্রকৃতি ও প্রযোজ্য আইনের ভিত্তিতে মামলার
                                                ধরন এবং বিচারিক প্রক্রিয়া নির্ধারিত হয়।
                                            </p>
...
<!-- =========================================================
     নারী ও শিশু নির্যাতন দমন MODAL
========================================================= -->
