...
<section class="legal-hero-section hero-3 position-relative">
            ...
            <div class="legal-hero-content">
                ...
                <form class="legal-search-form"
                    ...
                    <div class="main-search-row">
                        ...
                        <input type="text"
                               class="form-control"
                               placeholder="Search by Name, Practice Area, Location...">
                ...
                <div class="legal-category-links">

                    <a href="{{route('our.advocate-list')}}" class="active">
                        Advocates
                    </a>

                    <a href="{{route('our.barrister-list')}}">
                        Barristers
                    </a>

                    <a href="{{route('our.consultant-list')}}">
                        Legal Consultants
                    </a>

                    <a href="{{route('our.law-firm-list')}}">
                        Law Firms
                    </a>
        ...
        <div class="col-md-10 offset-md-1">
            ...
            <div class="row g-3 justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="legal-category-card">

                        <div class="category-icon advocates-icon">
                        ...
                        <p>
                            Find Advocates by location,
                            court & practice area
                        </p>

                        <a href="{{route('find.our.advocate-list')}}"
                           class="category-button advocates-button">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="legal-category-card">
                        ...
                        <div class="category-icon barristers-icon">
                        ...
                        <a href="{{route('find.our.barrister-list')}}"
                           class="category-button barristers-button">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="legal-category-card">
                        ...
                        <div class="category-icon consultants-icon">
                        ...
                        <a href="{{route('find.our.consultant-list')}}"
                           class="category-button consultants-button">
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    ...
                    <div class="legal-category-card">
                        ...
                        <div class="category-icon law-firms-icon">
                        ...
                        <a href="{{route('find.our.law-firm-list')}}"
                           class="category-button law-firms-button">
