...
<style type="text/css">
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    ...
    <div class="card-body">
        <form method="post" action="{{route('payroll.employee.details.training')}}">
            @csrf
            ...
            <div class="form-group">
              <table class="table-bordered text-center" width="100%">
                ...
                <tbody id="addRow">
                  ...
                  @foreach(@$trainings as $education)
                  <tr>
                    <td>
                      <input type="text" name="training[]" class="form-control form-control-sm" value="{{$education->training}}" placeholder="Training">
                    </td>
                    <td>
                      <input type="text" name="achievement[]" class="form-control form-control-sm" value="{{$education->achievement}}" placeholder="Achievement">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <input type="text" name="training[]" class="form-control form-control-sm" placeholder="Training">
                    </td>
                    <td>
                      <input type="text" name="achievement[]" class="form-control form-control-sm" placeholder="Achievement">
                    </td>
