...
<style type="text/css">
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    ...
    <div class="card-body">
        <form method="post" action="{{route('payroll.employee.details.educational')}}">
            @csrf
            ...
            <div class="form-group">
              <table class="table-bordered text-center" width="100%">
                ...
                <tbody id="addRow">
                  ...
                  <tr>
                    <td>
                      <input type="text" name="qualification[]" class="form-control form-control-sm" value="{{$education->qualification}}" placeholder="Qualification">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <input type="text" name="qualification[]" class="form-control form-control-sm" placeholder="Qualification">
                    </td>
                    <td>
