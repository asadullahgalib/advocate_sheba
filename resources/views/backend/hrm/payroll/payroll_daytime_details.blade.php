...
<style type="text/css">
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    ...
    <div class="card-body">
        <form method="post" action="{{route('payroll.employee.details.daytimes')}}">
            @csrf
            ...
            <div class="form-group">
              <table class="table-bordered text-center" width="100%">
                ...
                <tbody id="addRow">
                  @if(count($profile_times)>0)
                  @foreach(@$profile_times as $education)
                  <tr>
                    <td>
                      <input type="text" name="time[]" class="form-control form-control-sm" value="{{$education->time}}" placeholder="Day - Time">
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <input type="text" name="time[]" class="form-control form-control-sm" placeholder="Day - Time">
                    </td>
