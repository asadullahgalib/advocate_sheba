...
<style type="text/css">
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    ...
    <div class="card-body">
        <form method="post" action="{{route('payroll.employee.details.workplace')}}">
            @csrf
            ...
            <div class="form-group">
              <table class="table-bordered text-center" width="100%">
                ...
                <tbody id="addRow">
                  @if(count($work_places)>0)
                  @foreach(@$work_places as $education)
                  <tr>
                    <td>
                      <input type="text" name="workplace[]" class="form-control form-control-sm" value="{{$education->workplace}}" placeholder="Work Place">
                    </td>
                    <!-- <td>
                      <input type="text" name="details[]" class="form-control form-control-sm" value="{{$education->details}}" placeholder="Details/Mobile No">
                    </td> -->
                    <td>
                  ...
                  <tr>
                    <td>
                      <input type="text" name="workplace[]" class="form-control form-control-sm" placeholder="Work Place">
                    </td>
                    <!-- <td>
                      <input type="text" name="details[]" class="form-control form-control-sm" placeholder="Details / Mobile No">
                    </td> -->
