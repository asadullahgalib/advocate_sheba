  ...
  <div class="col-md-12" style="padding-top: 40px;">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">
            Dotor Details Info
            <a href="{{ route('payroll.employee.view') }}" class="btn btn-success float-right btn-sm custom_btn"><i class="fa fa-list"> Dotor List</i></a>
        </h3>
      </div>
    ...
    <div class="card-body">
      <form method="post" action="{{route('payroll.employee.details.personal')}}" enctype="multipart/form-data">
        @csrf
