...
<style type="text/css">
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    ...
    <div class="card-body">
        <form method="post" action="{{route('payroll.employee.details.experiences')}}">
            @csrf
            ...
            <div class="form-group">
              <table class="table-bordered text-center" width="100%">
                ...
                <tbody id="addRow">
                  ...
                  @foreach(@$experiences as $education)
                  <tr>
                    <td>
                      <input type="text" name="experience[]" class="form-control form-control-sm" value="{{$education->experience}}">
                    </td>
                    <td>
