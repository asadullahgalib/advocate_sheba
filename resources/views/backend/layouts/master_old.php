...
<head>
  ...
  <title>Esheba</title>
  <link rel="shortcut icon" href="{{asset('public/frontend/esheba')}}/images/favicon.ico" />
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('home')}}" class="brand-link">
      <img src="{{asset('public/frontend/esheba')}}/images/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; E-Sheba <a href=""></a>.</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>Developed by</b> Popularsoft
    </div>
  </footer>
