  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h5>{{(@$editData) ? ("Expense Update") : "Expense Add"}}
          <a class="btn btn-sm btn-success float-right" href="{{route('human-resource.expenses.expanse.view')}}"><i class="fa fa-list"></i> Expense List</a>
        </h5>
      </div>

      <div class="card-body">
          <form method="post" action="{{!empty($editData->id) ? route('human-resource.expenses.expanse.update',$editData->id) : route('human-resource.expenses.expanse.store')}}" id="myForm" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="form-row">
                ...
                <select name="expanse_type_id" id="expanse_type_id" class="expanse_type_id form-control form-control-sm select2">
                  ...
                  <option value="0">Others</option>
                      ...
                      <div class="form-group col-md-4">
                        <label>Date</label>
                        <input type="text" name="date" value="{{@$editData->date}}" class="form-control form-control-sm singledatepicker" placeholder="YYYY-MM-DD" readonly>
                      </div>
                  </div>
                  <div class="form-row">
              ...
              <div class="col-md-12">
                <input type="text" name="name" id="name" class=" form-control form-control-sm" placeholder="Write Expense Item">
              </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
      ...
      $('#myForm').validate({
        ignore:[],
            errorPlacement: function(error, element){
                if (element.attr("name") == "expanse_type_id" ){error.insertAfter(element.next()); }
