            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
						<h2 class="main-title float-left">Manage date wise deposit/withdraw</h2>
						<ol class="breadcrumb float-right">
							<li class="breadcrumb-item">Home</li>
							<li class="breadcrumb-item">deposit/withdraw</li>
						</ol>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-row">
								<div class="form-group col-sm-12">
									...
									<div class="custom-control custom-radio custom-control-inline">
									  ...
									  <label class="custom-control-label" for="defaultInline1">Date Wise Deposit</label>
									</div>
									...
									<div class="custom-control custom-radio custom-control-inline">
									  ...
									  <label class="custom-control-label" for="defaultInline2">Date  Wise Withdraw</label>
									</div>
								</div>
							</div>
							<div style="display: none;" class="show_supplier">
								<form method="GET" action="{{route('banks.bank.date-wise.deposit-report')}}" id="supplierWiseForm" target="_blank">
									<div class="form-row">
										<div class="col-sm-4">
							...
							<div style="display: none;" class="show_product">
								<form method="GET" action="{{route('banks.bank.date-wise.withdraw-report')}}" id="productWiseForm" target="_blank">
									<div class="form-row">
										<div class="col-sm-4">
											<label>Start Date</label>
							                <input type="text" name="start_date" class="form-control form-control-sm singledatepicker" placeholder="YYYY-MM-DD" readonly>
