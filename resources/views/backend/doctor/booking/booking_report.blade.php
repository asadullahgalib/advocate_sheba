...
@section('content')
  ...
  <div class="col-md-12" style="padding-top: 40px;">
    <div class="card">
      ...
      <div class="card-body">
				<form method="POST" action="{{route('doctor-profile.booking.report.pdf')}}" id="myForm" target="_blank">
					@csrf
					<div class="form-row">
						<div class="col-md-3">
...
<script type="text/javascript">
	$(document).on('click','#search',function(){
		var doctor_id = "<?php echo @Auth::user()->id; ?>"
		var start_date = $('#start_date').val();
		var end_date = $('#end_date').val();
		$.ajax({
			url: "{{route('doctor-profile.booking.report.handlebar')}}",
			type: "get",
			data: {
				'doctor_id': doctor_id,
