        ...
        return this.each(function(t, n) {
            var l = e(n),
                ...
                u = {
                    ...
                    _bindInput: function() {
                        p.changeInput && o.length > 0 && o.bind("click", u._clickHandler), l.on({
                            focus: function() {
                                o.addClass("focused")
                            },
                            blur: function() {
                    ...
                    _unbindInput: function() {
                        p.changeInput && o.length > 0 && o.unbind("click", u._clickHandler)
                    },
                    ...
                    _remove: function(i, n) {
                        if (n.binded) {
                            if ("undefined" != typeof n.data.id && (n = s.find(p.templates._selectors.item + "[data-jfiler-index='" + n.data.id + "']"), 0 == n.length)) return !1;
                        ...
                        var a = n.get(0).jfiler_id || n.attr("data-jfiler-index"),
                            ...
                            f = function(i) {
                                var n = r.find("input[name^='jfiler-items-exclude-']:hidden").first(),
                                    a = u._itFl[i],
                                    o = [];
                                if (0 == n.length && (n = e('<input type="hidden" name="jfiler-items-exclude-' + (p.excludeName ? p.excludeName : ("[]" != l.attr("name").slice(-2) ? l.attr("name") : l.attr("name").substring(0, l.attr("name").length - 2)) + "-" + t) + '">'), n.appendTo(r)), a.file._choosed || a.file._appended || a.uploaded) {
